...
public class BankingApp {
    ...
    public static void main(String[] args) {
        ...
        session.initializeSession(user, auth.loadUserAccounts(user), auth.loadUserDebitCard(user, AccountType.Savings),
                auth.loadUserDebitCard(user, AccountType.Checking),
